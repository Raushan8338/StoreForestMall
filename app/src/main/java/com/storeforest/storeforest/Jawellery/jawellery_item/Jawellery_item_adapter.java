...
public class Jawellery_item_adapter extends RecyclerView.Adapter<Jawellery_item_adapter.ProductViewHolder> {
    private ArrayList<Jawelery_details_item> jawelery_details_items;
    ...
    @NonNull
    @Override
    public Jawellery_item_adapter.ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.mobile_item_details, parent, false);
        Jawellery_item_adapter.ProductViewHolder lvh = new Jawellery_item_adapter.ProductViewHolder(view);
        return lvh;
    }
    @RequiresApi(api = Build.VERSION_CODES.N)
    @Override
    public void onBindViewHolder(@NonNull final Jawellery_item_adapter.ProductViewHolder holder, int position) {
        final Jawelery_details_item currentItem = jawelery_details_items.get(position);
    ...
    public int getItemCount() {
        return jawelery_details_items.size();
    }
    ...
    public Jawellery_item_adapter(Context context, ArrayList<Jawelery_details_item> jawelery_details_items, Boolean x) {
        this.context = context;
        // d = new Domain();
        this.jawelery_details_items = jawelery_details_items;
        this.x = x;
    }
