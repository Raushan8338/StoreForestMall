...
public class Add_second_hand_img extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_second_hand_img);
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (adhar.getDrawable() != null) {
                    ...
                    RequestQueue q =  Volley.newRequestQueue(Add_second_hand_img.this);
                    Domain d = new Domain();
                    final ProgressDialog progressDialog=new ProgressDialog(Add_second_hand_img.this);
                    progressDialog.setMessage("Please Wait !");
                    progressDialog.show();
                    String url ="https://trendingstories4u.com/android_app/add_second_hand_img.php?user_id="+sharedPreferences.getString(user_id, null)+"&name="+sharedPreferences.getString(user_name,null)+"&contact_no="+sharedPreferences.getString(mobile,null);
                    Log.e("urls",url);
                    ...
                    final StringRequest stringRequest=new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                                ...
                                Toast.makeText(Add_second_hand_img.this, "Thank you", Toast.LENGTH_SHORT).show();
                                Intent intent=new Intent(Add_second_hand_img.this, Add_second_hand_img2.class);
                                intent.putExtra("p_id",response);
                        ...
                        protected Map<String, String> getParams()
                        {
                            ...
                            params.put("brand",getIntent().getStringExtra("brand"));
                            params.put("category",getIntent().getStringExtra("category"));
                            params.put("title",getIntent().getStringExtra("title"));
                            params.put("describe",getIntent().getStringExtra("describe"));
