...
public class Add_second_hand_img4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_second_hand_img4);
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Add_second_hand_img4.this, Second_hand_thank_you.class);
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (adhar.getDrawable() != null) {
                    ...
                    RequestQueue q =  Volley.newRequestQueue(Add_second_hand_img4.this);
                    Domain d = new Domain();
                    final ProgressDialog progressDialog=new ProgressDialog(Add_second_hand_img4.this);
                    ...
                    final StringRequest stringRequest=new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                Toast.makeText(Add_second_hand_img4.this, "Thank you", Toast.LENGTH_SHORT).show();
                                Intent intent=new Intent(Add_second_hand_img4.this, Second_hand_thank_you.class);
                                startActivity(intent);
                                finish();
