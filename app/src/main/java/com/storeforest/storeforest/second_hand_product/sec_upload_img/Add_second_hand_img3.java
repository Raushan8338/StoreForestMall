...
public class Add_second_hand_img3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_second_hand_img3);
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Add_second_hand_img3.this, Second_hand_thank_you.class);
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (adhar.getDrawable() != null) {
                    ...
                    RequestQueue q =  Volley.newRequestQueue(Add_second_hand_img3.this);
                    Domain d = new Domain();
                    final ProgressDialog progressDialog=new ProgressDialog(Add_second_hand_img3.this);
                    ...
                    final StringRequest stringRequest=new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                                ...
                                Toast.makeText(Add_second_hand_img3.this, "Thank you", Toast.LENGTH_SHORT).show();
                                Intent intent=new Intent(Add_second_hand_img3.this, Add_second_hand_img4.class);
