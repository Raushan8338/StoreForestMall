...
SharedPreferences sharedPreferences2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       progressDialog.show();
        ...
        RequestQueue queues = Volley.newRequestQueue(Add_address.this);
        StringRequest stringRequests = new StringRequest(Request.Method.GET, urls, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(Add_address.this, "Server linking failed !!! Check your Internet Connection.", Toast.LENGTH_SHORT).show();
                }
            });
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (contact_no.getText().toString().equals("")){
                    Toast.makeText(Add_address.this, "Please Enter Contact no", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
                else if (street_name.getText().toString().equals("")){
                    Toast.makeText(Add_address.this, "Please Enter Street name", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }

                else if (house_no.getText().toString().equals("")){
                    Toast.makeText(Add_address.this, "Please Enter Your House no", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
                else if (pincode.getText().toString().equals("")){
                    Toast.makeText(Add_address.this, "Please Enter house no", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
                else {
                            ...
                            StringRequest stringRequest = new StringRequest(Request.Method.POST, Url,
                                    new Response.Listener<String>() {
                                        ...
                                        public void onResponse(String response) {
                                            ...
                                            progressDialog.dismiss();
                                            Toast.makeText(Add_address.this, response, Toast.LENGTH_SHORT).show();
                                            Intent intent=new Intent(Add_address.this, Display_cart_details.class);
                                    ...
                                    new Response.ErrorListener() {
                                        ...
                                        public void onErrorResponse(VolleyError volleyError) {
                                            ...
                                            Toast.makeText(Add_address.this, volleyError.toString(), Toast.LENGTH_LONG).show();
                                        }
                                    }) {
                                @Override
