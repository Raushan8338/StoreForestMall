...
public class Mobile_adapter  extends RecyclerView.Adapter<Mobile_adapter.ProductViewHolder> {

    private ArrayList<Mobiles_item> mobiles_items;
    //private Domain d;
    ...
    @NonNull
    @Override
    public Mobile_adapter.ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.mobile_item_display, parent, false);
        Mobile_adapter.ProductViewHolder lvh = new Mobile_adapter.ProductViewHolder(view);
        return lvh;
    }

    @RequiresApi(api = Build.VERSION_CODES.N)
    @Override
    public void onBindViewHolder(@NonNull final Mobile_adapter.ProductViewHolder holder, int position) {
        final Mobiles_item currentItem = mobiles_items.get(position);
 ...
 */
    ...
    public Mobile_adapter(Context context, ArrayList<Mobiles_item> mobiles_items, Boolean x) {
        this.context = context;
        // d = new Domain();
        this.mobiles_items = mobiles_items;
        this.x = x;
    }
