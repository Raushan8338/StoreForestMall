...
public class Shopper_order_details extends AppCompatActivity {
    Button b_amount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shopper_order_details);

        sharedPreferences1 = getSharedPreferences(MyPref, Context.MODE_PRIVATE);
        Domain d = new Domain();
        setTitle("History");
        RequestQueue queue =  Volley.newRequestQueue(this);
        progressDialog=new ProgressDialog(Shopper_order_details.this);
        progressDialog.show();
        // progressBar.setVisibility(View.VISIBLE);*//*
        final SharedPreferences sharedPreferences;
        String url = "https://trendingstories4u.com/android_app/shopper_booking_history.php?user_id="+sharedPreferences1.getString(user_id,null)+"&item_id="+getIntent().getStringExtra("item_id");
        Log.e("url",url);
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (obj.getString("result").equals("true")) {
                        ...
                        layoutManager = new LinearLayoutManager(Shopper_order_details.this);
                        adapter = new Order_adapter(Shopper_order_details.this, order_items);
