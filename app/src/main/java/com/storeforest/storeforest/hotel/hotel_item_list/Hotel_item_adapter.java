...
public class Hotel_item_adapter extends RecyclerView.Adapter<Hotel_item_adapter.ProductViewHolder> {
    private ArrayList<Hotel_item_details_items> hotel_item_details_items;
    private List<Hotel_item_details_items> exampleListFull;
    //private Domain d;
    ...
    @NonNull
    @Override
    public Hotel_item_adapter.ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.hotel_item_details_iems, parent, false);
        Hotel_item_adapter.ProductViewHolder lvh = new Hotel_item_adapter.ProductViewHolder(view);
        return lvh;
    }
    @RequiresApi(api = Build.VERSION_CODES.N)
    @Override
    public void onBindViewHolder(@NonNull final Hotel_item_adapter.ProductViewHolder holder, int position) {
        final Hotel_item_details_items currentItem = hotel_item_details_items.get(position);
    ...
    public int getItemCount() {
        return hotel_item_details_items.size();
    }
    ...
    public Hotel_item_adapter(Context context, ArrayList<Hotel_item_details_items> hotel_item_details_items, Boolean x) {
        this.context = context;
        // d = new Domain();
        this.hotel_item_details_items = hotel_item_details_items;
        this.x = x;
    }
